...
if ( escolhaDoTreinador === 1) {
    pokemonEscolhido = "Bulbasaur";
} else if ( escolhaDoTreinador ===  2) {  //Acrescentamos o numero aos Pokémons conforme solicitado na saida do console.
    pokemonEscolhido = "Charmander";
} else if ( escolhaDoTreinador === 4) {   //Acrescentamos o numero aos Pokémons conforme solicitado na saida do console.
    pokemonEscolhido = "Charmander";
    pokemonEscolhido = "Pikachu";
}else{
  pokemonEscolhido = "Mewtwo";
