...
//TODO: Agora implemente uma condição necessária para verificar e exibir se há tesouro na sala e se há montro na sala:
    if (temTesouro) {                           //Acrescentamos a Variavel temTesouro como condição para saber se tem tesouro na sala.
        print("Tesouro na sala " + sala + "!");
    } else if (temMonstro) {                    //Acrescentamos a Variavel temMonstro como condição para saber se tem Monstro na sala.
        print("Monstro na sala " + sala + "!");
    }
}