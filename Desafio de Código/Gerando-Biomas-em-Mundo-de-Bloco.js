...
// TODO: Defina aqui os tipos de minerais Carvao, Ferro, Diamante e Pedra
let minerais = ["Pedra" , "Carvao" , "Ferro" , "Diamante"]; //Acrescentamos o nome dos minerais.
...
for (let i = 1; i <= quantidadeGolpes; i++) {
  ...
  /* Acrscentamos a variavel i que representa o numero de golpes separados por uma string ": ",
     mais o tipo de minerio colhido pela array minerais e a variavel minaIndex. 
  */
}