...
Você receberá uma primeira parte do nome de um Pokémon e sua tarefa é completá-la com o sufixo mágico adequado, revelando
o nome completo do Pokémon.
...
Saída
A função deve retornar uma nova string que é a combinação da parte inicial(Préfixo) do nome do Pokémon com o sufixo final
do nome, formando um nome de Pokémon completo.
...
// TODO: Dentro da função, crie uma variável chamada "palavraPokemon" que é formada pela concatenação da "palavra" com
// a string "saur";  
...
// TODO: Defina uma função chamada "combinandoNomesPokemons" que recebe um parâmetro chamado (palavra);
function combinandoNomesPokemons(palavra) {     //Fizemos a função pedida.
    ...
    var palavraPokemon = palavra + "saur";      //Criamos a Variavel pedida com as suas informações.
    // TODO: Após a váriavel, retorne a palavra pokemon;
     return palavraPokemon;  // Retornando o resultado esperado.
    }
